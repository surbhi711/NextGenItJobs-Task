<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="JobListing.aspx.cs" Inherits="NextGenItJobs.User.JobListing" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        .radiobuttonlist {
            ...
            .radiobuttonlist span.selectradio label {
                background-color: #FFF;
                font-weight: bold;
                            ...
                            <div class="single-listing">
                                ...
                                <div class="select-job-items2">
                                    <asp:DropDownList ID="ddlCountry" runat="server" name="select" CssClass="form-control w-100"
                                        ...
                                        DataValueField="CountryName" OnSelectedIndexChanged="ddlCountry_SelectedIndexChanged" AutoPostBack="true">
